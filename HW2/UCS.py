'''UCS implementation of automated design of gear trains'''

import heapq                    #importing module for creating priority queue
...
class Node:                     #class for defining node
    ...
    def append_gear(self):       #appends the last gear to the array
...
class PriorityQueue:                #class for creating priority queue
    def __init__(self):
        self.items = []
    ...
    def enqueue(self, item):
        ...
        heapq.heappush(self.items,item)                 #prioritizes the queue according to transition function
...
class UCS:                          #class for UCS impelementation
...
def Main():
    ...
    for value in w_out:
        #print 'win is: ',w_in
        print 'wout is: ',value
        Search_method = UCS(w_in, value, gear_values);
